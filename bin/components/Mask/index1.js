...
var Mask = function (_Component) {
    ...
    function Mask(props) {
        ...
        _this.componentWillReceiveProps = function (nextProps) {
            console.log(_this.props.start, nextProps);
            if (nextProps.start) {
                _this.setState({
                    start: nextProps.start
                });
                oImg.src = _this.props.imgSource[nextProps.start].imgurl;
            }
        };
        ...
        _this.changeImg = function () {
            ...
            document.body.appendChild((0, _reactDom.findDOMNode)(_this.refs.mask));
            ...
            oImg.onload = function () {
                ...
                var imgWidth = oImg.width || 400;
                var imgHeight = oImg.height || 300;
                ...
                (0, _reactDom.findDOMNode)(_this.refs.imageBox).appendChild(oImg);
            };
        };
    ...
    _createClass(Mask, [{
        ...
        value: function nextImage(dir) {
            ...
            (0, _reactDom.findDOMNode)(document.getElementById('showImg')).src = this.props.imgSource[cur].imgurl;
        }
    }, {
        key: 'render',
