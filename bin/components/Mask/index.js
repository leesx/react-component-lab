...
var Mask = function (_Component) {
    ...
    function Mask(props) {
        ...
        _this.resizeImg = function () {
            ...
            var imgObj = (0, _reactDom.findDOMNode)(document.getElementById('showImg'));
        ...
        _this.preLoadImg = function (oImg) {
            ...
            oImg.onload = function () {
                ...
                if (!_this.props.showModal) return;
                _this.setState({
                    loadingImg: false
                });
    ...
    _createClass(Mask, [{
        ...
        value: function render() {
            var isDisplay = this.props.showModal ? 'show' : 'hide';
            var styles = {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { className: 'mask', onClick: this.props.closePicModal }),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { id: 'showImg', key: 'image-box', style: styles, src: this.props.imgSource[this.state.start].imgurl })
                    ),
                    this.renderArrow(),
