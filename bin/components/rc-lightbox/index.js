...
var LightBox = function (_Component) {
    ...
    function LightBox(props) {
        ...
        _this.renderArrow = function () {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'lb-nav' },
                _react2.default.createElement('a', { className: cur === 0 ? 'lb-prev hide' : 'lb-prev', onClick: _this.nextImage.bind(_this, 0) }),
                _react2.default.createElement('a', { className: cur === _this.props.imgSource.length - 1 ? 'lb-next hide' : 'lb-next', onClick: _this.nextImage.bind(_this, 1) })
            );
        };
    ...
    _createClass(LightBox, [{
        ...
        value: function render() {
            var displayStyle = this.props.isOpen ? { display: 'block' } : { display: 'none' };
            ...
            return _react2.default.createElement(
                'div',
                { ref: 'lightBox', style: displayStyle },
                ...
                _react2.default.createElement(
                    'div',
                    { id: 'lightbox', className: 'lightbox', ref: 'imageBox', style: { top: top, left: left }, onClick: this.handleClickOuter.bind(this) },
                    _react2.default.createElement(
                        'div',
                        { className: 'lb-outerContainer', style: { width: '' + (imgWidth + 8), height: '' + (imgHeight + 8) }, onClick: this.handleClickOuter.bind(this) },
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'lb-loader', style: { width: '100%', height: 300, display: this.state.loadingImg ? 'block' : 'none' } },
                                _react2.default.createElement('a', { className: 'lb-cancel' })
                            )
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'lb-dataContainer', style: { width: '' + (imgWidth + 8), height: '' + (imgHeight + 8) } },
                        _react2.default.createElement(
                            'div',
                            { className: 'lb-data' },
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('span', { className: 'lb-caption' }),
                                _react2.default.createElement(
                                    'span',
                                    { className: 'lb-number' },
                                    this.state.currentImage + 1 + '/' + this.props.imgSource.length
                                )
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'lb-closeContainer' },
                                _react2.default.createElement('a', { className: 'lb-close', onClick: this.props.onClose })
                            )
                        )
                    )
                )
